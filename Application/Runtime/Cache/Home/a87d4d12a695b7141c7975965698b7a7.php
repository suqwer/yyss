            ...
            <div class="row">
                <div class="col-md-2">
                    <ul class="nav nav-pills nav-stacked" style="max-width: 300px;">
                        <li><a href="/index.php/home/user/myLetter"><i class="fa fa-home fa-fw"></i>&nbsp;消息中心</a></li>
                        <li><a href="javascript:void(0)"><i class="fa fa-id-badge fa-fw"></i>&nbsp;回复我的</a></li>
                        <li><a href="javascript:void(0)"><i class="fa fa-superpowers fa-fw"></i>&nbsp;@ 我的</a></li>
                        <li><a href="javascript:void(0)"><i class="fa fa-user-o fa-fw"></i>&nbsp;收到的赞</a></li>
                        <li><a href="javascript:void(0)"><i class="fa fa-user-o fa-fw"></i>&nbsp;系统通知</a></li>
                        <li  class="active"><a href="/index.php/home/user/myprivateLetter"><i class="fa fa-user-o fa-fw"></i>&nbsp;我的私信</a></li>
                    </ul>
                </div>
                <div class="col-md-10">
                    <div class="panel panel-info">
                        ...
                        <div class="panel-body">
                            ...
                            <div class='row'>
                                <div class='col-md-3'>
                                    <div class="panel panel-default">
                                        <div class="panel-heading"><a  style="text-decoration:none" href="">近期消息</a></div>
                                        <div class="panel-body">
                                            <div class='col-md-12'>
